...
*/
	...
	$oPluginAdmin  = new PluginAdmin('LMBlogPaginate');
	...
	{
		$oPluginAdmin->start();
		echo '<p>You must be logged in to use the LMBlogPaginate plugin admin area.</p>';
		$oPluginAdmin->end();
		exit;
	}
	...
	{
		$oPluginAdmin->start();
		echo '<p>You must be the blog super admin to use the LMBlogPaginate plugin admin area.</p>';
		$oPluginAdmin->end();
		exit;
	}
	...
	echo '<h2>LMBlogPaginate Administration</h2>';
